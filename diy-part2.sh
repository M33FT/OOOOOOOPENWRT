...
# Campus Network
#
# CONFIG_PACKAGE_BitSrunLoginGo is not set
...
CONFIG_OVERRIDE_PKGS="brook chinadns-ng dns2socks dns2tcp hysteria ipt2socks microsocks naiveproxy pdnsd-alt sagernet-core shadowsocksr-libev simple-obfs ssocks tcping trojan trojan-go trojan-plus v2ray-geodata"
